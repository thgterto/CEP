const SPC = {
    ...
    calculateDescriptiveStats: (data) => {
        ...
        // Optimization: Cache computationally expensive jStat results (like mean, stdev, and quartiles)
        // to avoid redundant O(N log N) sorting and O(N) loops in internal jStat implementations.
        const mean = j.mean();
