const SPC = {
    ...
    // Optimization: Replacing array operations (push, spread operator) and multiple traversals
    // with a pre-allocated array and a single-pass loop yields a massive performance speedup
    // and prevents "Maximum call stack size exceeded" errors on very large datasets.
    computeIMR: (data) => {
