const SPC = {
    ...
    computeXbarR: (data, n = 5) => {
        ...
        // Optimization: Pre-allocate arrays and calculate min/max/mean in a single loop
        // avoids slicing arrays and using higher-order methods mapping over the slices
    ...
    computeXbarS: (data, n = 5) => {
        ...
        // Optimization: Pre-allocate arrays and manually calculate mean and standard deviation
        // avoiding slicing arrays and multiple iterations over sub-group slices
        const xbars = new Array(numGroups);
