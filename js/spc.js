const SPC = {
    ...
    computeIMR: (data) => {
        ...
        // Optimization: Single-pass calculation with pre-allocated array avoids O(N) spread and map overhead
        const ranges = new Array(len);
        ranges[0] = 0; // First element has no moving range
