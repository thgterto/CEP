const SPC = {
    ...
    computeRunChart: (data) => {
        // Optimization: Using Float64Array for sorting massive numeric arrays is significantly faster
        // than standard Array.prototype.sort((a,b) => a-b) and also safely creates a copy.
