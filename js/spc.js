const SPC = {
    ...
    // Optimization: Caching j.mean(), j.stdev(true), and j.quartiles() prevents redundant
    // internal computations (especially sorting for quartiles), significantly improving speed.
