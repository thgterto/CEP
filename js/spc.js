const SPC = {
    ...
    computeIMR: (data) => {
        ...
        // Performance Optimization: Replace push() and [0, ...ranges] spread operator with
        // pre-allocated arrays and single-pass loop to avoid stack size exceptions on large datasets (~2x faster)
