const SPC = {
    ...
    // Optimization: Avoid intermediate arrays and array spread operations to prevent
    // O(N) allocation overhead and potential Max Call Stack size exceeded on large datasets.
    ...
    // Optimization: Avoid intermediate arrays to reduce memory footprint and GC pauses
    // Calculates variance manually within the same pass for better O(N) cache locality.
