const SPC = {
    ...
    computeCUSUM: (data, target = null, sigma = null) => {
        ...
        // Optimization: Pre-allocate arrays and manually track state instead of push/shift.
        // Also inline Math.max/min and cache invariants for performance on large datasets.
